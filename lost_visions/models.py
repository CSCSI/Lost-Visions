...
class Book(models.Model):
    ...
    volume = models.TextField(max_length=120L, blank=True)
    publisher = models.TextField(max_length=256L, blank=True)
    title = models.TextField(max_length=256L)
    first_author = models.TextField(max_length=120L, blank=True)
    BL_DLS_ID = models.TextField(max_length=120L, blank=True)
    pubplace = models.TextField(max_length=120L, blank=True)
    book_identifier = models.TextField(unique=True, max_length=120L, blank=True)
    ARK_id_of_book = models.TextField(max_length=120L, blank=True)
    date = models.TextField(max_length=120L, blank=True)
